...
const SEED_WORK_ORDERS = [{
  ...
  checklist: [{
    id: 'c1',
    title: 'Brake fluid level & boiling point test',
    status: 'PASS'
  }, {
    id: 'c2',
    title: 'Front brake pads thickness check',
    status: 'FAIL',
    notes: 'Worn to 2.2mm'
  }, {
    id: 'c3',
    title: 'Front brake rotors runout & thickness',
    status: 'PASS',
    notes: '25.4mm'
  }, {
    id: 'c4',
    title: 'Tire tread depth & pressure',
    status: 'PASS',
    notes: '5.5mm even wear'
  }, {
    id: 'c5',
    title: 'Suspension ball joints & bushings',
    status: 'PASS'
  }],
  partsUsed: [{
    partId: 'p-brk-01',
    name: 'Brembo Front Brake Pad Set (P68060)',
    quantity: 1,
    unitPrice: 78.50,
    total: 78.50
  }, {
  ...
  checklist: [{
    ...
    id: 'c3',
    title: 'Underbody & Exhaust Inspection',
    status: 'PASS'
  }],
  partsUsed: [{
    partId: 'p-oil-01',
    name: 'Total Quartz Ineo 5W-30 (7 Liters)',
    quantity: 1,
    unitPrice: 84.00,
    total: 84.00
  }, {
    partId: 'p-flt-01',
    name: 'Purflux Oil Filter Element',
    quantity: 1,
    unitPrice: 16.50,
    total: 16.50
  }],
  ...
  checklist: [{
    id: 'c1',
    title: 'HV Battery State of Health Diagnostics',
    status: 'PASS',
    notes: 'SOH: 97.4%'
  }, {
    id: 'c2',
    title: 'Laser Alignment Geometry Scan',
    status: 'FAIL',
    notes: 'Front toe +0.22°'
  }, {
    id: 'c3',
    title: 'HEPA Dual Cabin Filter Test',
    status: 'FAIL',
    notes: 'Heavy pollen clogging'
  }],
  partsUsed: [{
    partId: 'p-ch-01',
    name: 'OEM Tesla Model Y Dual HEPA Cabin Filter Set',
    quantity: 1,
    unitPrice: 65.00,
    total: 65.00
  }],
...
class StorageService {
  ...
  static getAppointments(tenantId) {
...
class SchedulingService {
   ...
   */
  static getAvailableSlots(tenantId, serviceId, date) {
    ...
    const existingAppointments = StorageService.getAppointments(tenantId).filter(a => a.date === date && a.status !== 'CANCELLED');
  ...
  static checkConflict(params) {
    ...
    const appointments = StorageService.getAppointments(tenantId).filter(a => a.date === date && a.status !== 'CANCELLED' && a.id !== excludeAppointmentId);
  ...
  static confirmAppointment(params) {
    ...
    const workOrder = {
      ...
      checklist: [{
        id: 'chk-1',
        title: 'Vehicle exterior walkaround & fluid check',
        status: 'PASS'
      }, {
        id: 'chk-2',
        title: 'Brake, tire & suspension visual check',
        status: 'PASS'
      }, {
        id: 'chk-3',
        title: 'OBD-II diagnostic health scan',
        status: 'PASS'
      }],
      partsUsed: [],
...
// --- FILE: services/QuoteInvoiceService.ts ---
// ==========================================================================
...
class QuoteInvoiceService {
   ...
   */
  static approveQuote(quoteId, signature) {
    const quotes = StorageService.getAllQuotes();
   ...
   */
  static rejectQuote(quoteId, reason) {
    const quotes = StorageService.getAllQuotes();
    const quote = quotes.find(q => q.id === quoteId);
    if (!quote) throw new Error('Quote not found');
   ...
   */
  static generateInvoiceFromWorkOrder(workOrderId) {
    const workOrders = StorageService.getAllWorkOrders();
...
// --- FILE: services/EInvoiceConnector.ts ---
// ==========================================================================
...
class EInvoiceConnector {
   ...
   */
  static generatePayload(invoice) {
...
<rsm:CrossIndustryInvoice xmlns:rsm="urn:un:unece:uncefact:data:standard:CrossIndustryInvoice:100"
   ...
   */
  static submitToChorusPro(invoiceId, platform = 'CHORUS_PRO') {
    const invoices = StorageService.getAllInvoices();
...
class CommunicationService {
   ...
   */
  static notifyBookingConfirmed(app, customer, tenant) {
    // 1. SMS
   ...
   */
  static notifyQuoteReady(quote, customer, tenant, magicLinkUrl) {
    this.sendNotification({
      tenantId: tenant.id,
      customerId: customer.id,
      recipient: customer.phone,
   ...
   */
  static notifyVehicleReady(customer, tenant, licensePlate) {
    this.sendNotification({
      tenantId: tenant.id,
      customerId: customer.id,
      recipient: customer.phone,
...
class AIService {
   ...
   */
  static async processCustomerIntake(tenantId, userInput, targetDate) {
    const functionCalls = [];
    ...
    if (lower.includes('brake') || lower.includes('frein') || lower.includes('squeak') || lower.includes('grincement') || lower.includes('vibrat')) {
      ...
      suggestedOBDChecks = ['Inspect brake pad thickness (front & rear)', 'Check rotor runout with dial gauge', 'Verify ABS wheel speed sensors and wiring harnesses'];
      ...
      suggestedOBDChecks = ['Perform 35-point multipoint vehicle inspection', 'Check engine oil condition and oil filter seal', 'Inspect auxiliary drive belt and coolant freeze point'];
      ...
      suggestedOBDChecks = ['High-Voltage isolation resistance diagnostic test', 'BMS State of Health (SOH) cell balance measurement', 'Thermal cooling pump flow rate check'];
    } else {
      matchedService = services.find(s => s.category === 'DIAGNOSTIC') || services[0];
      suggestedOBDChecks = ['Full ECU OBD-II Diagnostic Scan (powertrain & CAN bus)', 'Live sensor telemetry data recording', 'Fuel trim (STFT/LTFT) and oxygen sensor verification'];
    }
    functionCalls.push({
...
// --- FILE: components/LegalModals.tsx ---
// ==========================================================================
...
const LegalModal = ({
  ...
  }, type === 'PRIVACY' ? /*#__PURE__*/React.createElement(ShieldCheck, {
    size: 24
  ...
  }, type === 'PRIVACY' && 'GDPR & Data Privacy Policy', type === 'TERMS' && 'Terms of Service & SaaS Agreement', type === 'EINVOICE_INFO' && 'French & Swiss E-Invoicing Compliance'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '12px',
      color: '#86868b'
    }
  }, "Developed by MARS Association \u2022 Compliant with EU / Swiss Data Laws"))), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      background: 'none',
      border: 'none',
  ...
  }, type === 'PRIVACY' && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h4", {
    style: {
      fontWeight: 600,
      marginTop: '12px',
      color: '#1d1d1f'
    }
  }, "1. EU Hosting & Data Sovereignty"), /*#__PURE__*/React.createElement("p", null, "All tenant databases, customer vehicle service histories, quotes, and billing snapshots are hosted exclusively within certified European Union datacenters (Paris / Frankfurt) and Swiss sovereign data boundaries, complying fully with EU Regulation 2016/679 (GDPR) and the Swiss Federal Act on Data Protection (FADP/nLPD)."), /*#__PURE__*/React.createElement("h4", {
    style: {
      fontWeight: 600,
      marginTop: '16px',
      color: '#1d1d1f'
    }
  }, "2. Right to Access, Export & Erasure"), /*#__PURE__*/React.createElement("p", null, "Automotive workshop customers have the full legal right to request a complete JSON export of their service records or request immediate anonymization/deletion of contact details upon written notice."), /*#__PURE__*/React.createElement("h4", {
    style: {
      fontWeight: 600,
      marginTop: '16px',
      color: '#1d1d1f'
    }
  }, "3. Customer Consent Management"), /*#__PURE__*/React.createElement("p", null, "Transactional communications (Appointment confirmations, Quote approval links, Vehicle Ready notifications) are dispatched strictly based on explicit customer opt-in consent recorded at intake.")), type === 'TERMS' && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h4", {
    style: {
      fontWeight: 600,
      marginTop: '12px',
      color: '#1d1d1f'
    }
  }, "1. Platform License & SLA"), /*#__PURE__*/React.createElement("p", null, "AtelierOS provides multi-tenant SaaS operating software for automotive repair facilities. Uptime commitment is 99.9% with continuous automated backups."), /*#__PURE__*/React.createElement("h4", {
    style: {
      fontWeight: 600,
      marginTop: '16px',
      color: '#1d1d1f'
    }
  }, "2. AI Assistant Boundaries & Disclaimers"), /*#__PURE__*/React.createElement("p", null, "The AutoAI intake and diagnostic assistant functions purely as a triaging tool via bounded API calls. Official mechanical diagnostics, parts quotes, and quality control sign-offs remain the sole responsibility of the certified workshop technician."), /*#__PURE__*/React.createElement("h4", {
    style: {
      fontWeight: 600,
      marginTop: '16px',
      color: '#1d1d1f'
    }
  }, "3. Multi-Tenant Data Isolation"), /*#__PURE__*/React.createElement("p", null, "Each garage tenant possesses strict row-level cryptographic isolation. No garage can view or access customer records, pricing, or calendar events of another facility.")), type === 'EINVOICE_INFO' && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h4", {
    style: {
      fontWeight: 600,
      marginTop: '12px',
      color: '#1d1d1f'
    }
  }, "1. France: Chorus Pro & Factur-X / PPF"), /*#__PURE__*/React.createElement("p", null, "AtelierOS generates standard Factur-X (CII hybrid XML/PDF) and UBL 2.1 payloads ready for direct transmission to the French Portail Public de Facturation (PPF) and registered Plateformes de D\xE9mat\xE9rialisation Partenaire (PDP)."), /*#__PURE__*/React.createElement("h4", {
    style: {
      fontWeight: 600,
      marginTop: '16px',
      color: '#1d1d1f'
    }
  }, "2. Switzerland: QR-Bill Standard"), /*#__PURE__*/React.createElement("p", null, "Invoices issued under Swiss jurisdiction (CHF) feature standardized QR-Bill data payloads including structured reference numbers (QR-IBAN) conforming to Swiss Payment Standards 2024."))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '24px',
      display: 'flex',
      justifyContent: 'flex-end'
...
const Header = ({
  ...
  return /*#__PURE__*/React.createElement("header", {
  ...
  }, "Atelier", /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#0071e3'
    }
  }, "OS")))), /*#__PURE__*/React.createElement("span", {
    className: "apple-badge apple-badge-neutral",
    style: {
      fontSize: '11px',
      display: 'none',
      lg: 'inline-flex'
    }
  }, t.underDevBadge)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: '8px'
  ...
  }, activeTenant.name), /*#__PURE__*/React.createElement("span", {
    className: `apple-badge ${activeTenant.country === 'FR' ? 'apple-badge-blue' : 'apple-badge-amber'}`,
    style: {
      padding: '2px 6px',
      fontSize: '10px'
    }
  }, activeTenant.country, " (", activeTenant.currency, ")"), /*#__PURE__*/React.createElement(ChevronDown, {
    size: 14
  })), tenantDropdownOpen && /*#__PURE__*/React.createElement("div", {
  ...
  }, t.nav.tenantSwitch), tenants.map(tenant => /*#__PURE__*/React.createElement("div", {
    key: tenant.id,
    onClick: () => {
    ...
    className: `apple-badge ${tenant.country === 'FR' ? 'apple-badge-blue' : 'apple-badge-amber'}`,
    style: {
      fontSize: '10px',
      padding: '2px 6px'
    }
  }, tenant.country, " \u2022 ", tenant.currency)), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '11px',
      color: '#86868b'
    }
  }, tenant.address.city, ", ", tenant.country === 'FR' ? `SIRET: ${tenant.taxIdentity.siret?.substring(0, 9)}...` : `UID: ${tenant.taxIdentity.uid}`))))), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative'
    }
  }, /*#__PURE__*/React.createElement("button", {
  ...
  }, currentLanguage), /*#__PURE__*/React.createElement(ChevronDown, {
    size: 12
  })), langDropdownOpen && /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      position: 'absolute',
      top: '100%',
    ...
    size: 14
  }), /*#__PURE__*/React.createElement("span", null, "AutoAI")), /*#__PURE__*/React.createElement("button", {
    onClick: onResetDemo,
    className: "apple-btn-secondary",
...
const LandingPage = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    size: 14
  }), /*#__PURE__*/React.createElement("span", null, tl.badgeUnifiedEngine))), /*#__PURE__*/React.createElement("h1", {
    style: {
  ...
  }, tl.heroTitle), /*#__PURE__*/React.createElement("p", {
    style: {
  ...
  }, tl.heroSubtitle), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: '14px',
  ...
  }, /*#__PURE__*/React.createElement("span", null, tl.ctaLaunchApp), /*#__PURE__*/React.createElement(ArrowRight, {
    size: 18
  })), /*#__PURE__*/React.createElement("button", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, tl.ctaCustomerBooking)), /*#__PURE__*/React.createElement("button", {
    onClick: onOpenAi,
    className: "apple-btn-secondary",
    style: {
      fontSize: '16px',
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, tl.ctaAiReception))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    }, s.num), /*#__PURE__*/React.createElement(Icon, {
      size: 20,
      color: "#86868b"
    })), /*#__PURE__*/React.createElement("span", {
      style: {
  ...
  }, tl.featuresTitle), /*#__PURE__*/React.createElement("p", {
    style: {
      color: '#6e6e73',
      fontSize: '16px'
    }
  }, "Built on a modular, isolated multi-tenant architecture designed to scale seamlessly across garages.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, tl.roiTitle), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '14px',
      color: '#a1a1a6'
    }
  }, tl.roiSubtitle))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, tl.roiMechanicsLabel), /*#__PURE__*/React.createElement("span", {
    style: {
      fontWeight: 700,
      color: '#64d2ff'
    }
  }, mechanicsCount, " mechanics")), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: 1,
    max: 20,
  ...
  }, tl.roiMonthlyWorkOrders), /*#__PURE__*/React.createElement("span", {
    style: {
      fontWeight: 700,
      color: '#64d2ff'
    }
  }, monthlyOrders, " orders")), /*#__PURE__*/React.createElement("input", {
    type: "range",
    min: 20,
    max: 500,
    step: 10,
  ...
  }, tl.roiHoursSaved), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '32px',
      fontWeight: 800,
      color: '#30d158'
    }
  }, "~", hoursSavedPerMonth, " hours")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '12px',
      color: '#a1a1a6',
      textTransform: 'uppercase',
  ...
  }, tl.roiRevenueGain), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '36px',
      fontWeight: 800,
      color: '#ffffff'
    }
  }, "+", revenueGain.toLocaleString(), " ", pricingCurrency === 'EUR' ? '€' : 'CHF'), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '11px',
      color: '#a1a1a6'
    }
  }, "Based on recovered billable bay hours & reduced administrative phone tag.")))))), /*#__PURE__*/React.createElement("section", {
    style: {
  ...
  }, tl.pricingTitle), /*#__PURE__*/React.createElement("p", {
    style: {
      color: '#6e6e73',
      fontSize: '16px',
      marginBottom: '20px'
    }
  }, tl.pricingSubtitle), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'inline-flex',
  ...
  }, "EUR (\u20AC France)"), /*#__PURE__*/React.createElement("button", {
  ...
  }, "CHF (Switzerland)"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, tl.tierStarterName), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13px',
      color: '#6e6e73',
      marginBottom: '20px',
  ...
  }, tl.tierStarterDesc), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: '24px'
    }
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, pricingCurrency === 'EUR' ? tl.tierStarterPriceEur : tl.tierStarterPriceChf), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '13px',
      color: '#86868b'
    }
  }, " ", tl.tierStarterPeriod)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '12px',
  ...
  }, [tl.tierStarterFeat1, tl.tierStarterFeat2, tl.tierStarterFeat3, tl.tierStarterFeat4].map((feat, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: 'flex',
      alignItems: 'center',
    ...
    size: 16,
    color: "#30d158"
  }), /*#__PURE__*/React.createElement("span", null, feat)))), /*#__PURE__*/React.createElement("button", {
    onClick: onLaunchApp,
    className: "apple-btn-secondary",
    style: {
      width: '100%'
    }
  }, "Get Started with Starter")), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      padding: '32px',
      display: 'flex',
  ...
  }, tl.tierProBadge), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontSize: '20px',
      fontWeight: 700,
      marginBottom: '8px'
    }
  }, tl.tierProName), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13px',
      color: '#6e6e73',
      marginBottom: '20px',
  ...
  }, tl.tierProDesc), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: '24px'
    }
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, pricingCurrency === 'EUR' ? tl.tierProPriceEur : tl.tierProPriceChf), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '13px',
      color: '#86868b'
    }
  }, " ", tl.tierProPeriod)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '12px',
  ...
  }, [tl.tierProFeat1, tl.tierProFeat2, tl.tierProFeat3, tl.tierProFeat4, tl.tierProFeat5].map((feat, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, "Launch Pro Workshop")), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      padding: '32px',
      display: 'flex',
  ...
  }, tl.tierAiName), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13px',
      color: '#6e6e73',
      marginBottom: '20px',
  ...
  }, tl.tierAiDesc), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: '24px'
    }
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, pricingCurrency === 'EUR' ? tl.tierAiPriceEur : tl.tierAiPriceChf), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '13px',
      color: '#86868b'
    }
  }, " ", tl.tierAiPeriod)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '12px',
  ...
  }, [tl.tierAiFeat1, tl.tierAiFeat2, tl.tierAiFeat3, tl.tierAiFeat4, tl.tierAiFeat5].map((feat, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, "Test AI Receptionist")))), /*#__PURE__*/React.createElement("footer", {
    style: {
  ...
  }, "AtelierOS \u2022 Auto Workshop SaaS"), /*#__PURE__*/React.createElement("span", null, t.underDevBadge, " \u2022 Lead Client: Luca Sigon")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '20px',
      flexWrap: 'wrap'
  ...
  }, "Privacy Policy (GDPR)"), /*#__PURE__*/React.createElement("button", {
...
// --- FILE: components/StaffCalendar.tsx ---
// ==========================================================================
...
const StaffCalendar = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, tc.title), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '14px',
      color: '#6e6e73'
    }
  }, tc.subtitle)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '10px',
      flexWrap: 'wrap',
    ...
    value: "ALL"
  }, tc.filterMechanic), mechanics.map(m => /*#__PURE__*/React.createElement("option", {
    key: m.id,
    value: m.id
    ...
    value: "ALL"
  }, tc.filterBay), bays.map(b => /*#__PURE__*/React.createElement("option", {
    key: b.id,
    value: b.id
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, tc.newAppointment)))), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      padding: '24px',
      overflow: 'hidden'
  ...
  }, "Schedule for ", new Date(currentDate).toLocaleDateString(currentLanguage, {
    weekday: 'long',
    year: 'numeric',
    month: 'long',
    day: 'numeric'
    ...
    className: "apple-badge apple-badge-blue"
  }, filteredAppointments.length, " Appointments Booked")), filteredAppointments.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '60px 20px',
      color: '#86868b'
  ...
  }, tc.noAppointments), /*#__PURE__*/React.createElement("button", {
    ...
    size: 14
  }), /*#__PURE__*/React.createElement("span", null, "Schedule First Appointment"))) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      size: 15
    }), /*#__PURE__*/React.createElement("span", null, app.startTime, " - ", app.endTime)), /*#__PURE__*/React.createElement("span", {
      className: "apple-badge apple-badge-green",
      style: {
        fontSize: '11px'
      }
    }, app.status)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h4", {
      style: {
        fontSize: '15px',
        fontWeight: 600,
        color: '#1d1d1f',
    ...
    }, service?.name || 'Automotive Inspection'), /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: '12px',
        color: '#6e6e73'
      }
    }, "Ref: ", /*#__PURE__*/React.createElement("strong", null, app.confirmationCode), " \u2022 Source: ", app.source)), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        flexDirection: 'column',
        gap: '6px',
    ...
    }, customer?.firstName, " ", customer?.lastName, " (", customer?.phone, ")")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        alignItems: 'center',
        gap: '6px'
      ...
      size: 14,
      color: "#6e6e73"
    }), /*#__PURE__*/React.createElement("span", null, vehicle?.make, " ", vehicle?.model, " \u2022 ", /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 600
      }
    }, vehicle?.licensePlate))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        alignItems: 'center',
        gap: '6px'
      ...
      size: 14,
      color: "#6e6e73"
    }), /*#__PURE__*/React.createElement("span", null, "Mech: ", /*#__PURE__*/React.createElement("strong", null, mechanic?.name), " | ", bay?.name))), app.intakeNotes && /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: '12px',
        color: '#6e6e73',
        fontStyle: 'italic'
  ...
  }, tc.newAppointment), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13px',
      color: '#6e6e73',
      marginBottom: '20px'
    }
  }, "Central Scheduling Engine ensures zero mechanic and bay double bookings."), conflictError && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, conflictError), suggestedSlots.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '8px',
      fontSize: '12px',
      color: '#1d1d1f'
    }
  }, /*#__PURE__*/React.createElement("strong", null, tc.suggestAlternatives), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '6px',
      marginTop: '6px',
  ...
  }, suggestedSlots.map((slot, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    type: "button",
    onClick: () => {
  ...
  }, slot.startTime, " - ", slot.endTime, " (", slot.mechanicName, ")")))))), /*#__PURE__*/React.createElement("form", {
    ...
    key: c.id,
    value: c.id
  }, c.firstName, " ", c.lastName, " (", c.phone, ")")))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
  ...
  }, vehicles.map(v => /*#__PURE__*/React.createElement("option", {
    key: v.id,
    value: v.id
  }, v.make, " ", v.model, " (", v.licensePlate, ")")))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
  ...
  }, "Service Catalog Item"), /*#__PURE__*/React.createElement("select", {
    value: formServiceId,
    ...
    key: s.id,
    value: s.id
  }, s.name, " (", s.estimatedDurationMin, " min)")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, "Assigned Mechanic"), /*#__PURE__*/React.createElement("select", {
  ...
  }, mechanics.map(m => /*#__PURE__*/React.createElement("option", {
    key: m.id,
    value: m.id
  }, m.name)))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
  ...
  }, "Assigned Bay/Lift"), /*#__PURE__*/React.createElement("select", {
    value: formBayId,
  ...
  }, bays.map(b => /*#__PURE__*/React.createElement("option", {
    key: b.id,
    value: b.id
  }, b.name))))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
  ...
  }, "Intake Notes"), /*#__PURE__*/React.createElement("textarea", {
    value: formNotes,
...
// --- FILE: components/WorkOrderBoard.tsx ---
// ==========================================================================
// AtelierOS - 10-Stage Work Order Operations Board
// ==========================================================================

const STAGES = ['REQUEST', 'APPOINTMENT', 'DIAGNOSIS', 'QUOTE', 'AWAITING_APPROVAL', 'APPROVED', 'IN_PROGRESS', 'QUALITY_CHECK', 'READY', 'DELIVERED', 'INVOICED'];
const WorkOrderBoard = ({
  ...
  const advanceStage = (woId, direction) => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, two.title), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '14px',
      color: '#6e6e73'
    }
  }, two.subtitle)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '10px'
    }
  ...
  }, workOrders.length, " Active Orders"))), /*#__PURE__*/React.createElement("div", {
    className: "scrollbar-none",
    style: {
      display: 'flex',
      gap: '16px',
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, stageOrders.length)), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        flexDirection: 'column',
        gap: '10px',
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          ...
          flexDirection: 'column',
          gap: '8px',
          borderLeft: `3px solid ${wo.stage === 'INVOICED' ? '#30d158' : wo.stage === 'IN_PROGRESS' ? '#0071e3' : wo.stage === 'AWAITING_APPROVAL' ? '#ff9f0a' : '#86868b'}`
        },
      ...
      }, wo.orderNumber), /*#__PURE__*/React.createElement("span", {
        style: {
          fontSize: '11px',
          color: '#86868b'
        }
      }, new Date(wo.createdAt).toLocaleDateString())), /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: '13px',
          fontWeight: 600,
          color: '#1d1d1f'
        }
      }, vehicle?.make, " ", vehicle?.model), /*#__PURE__*/React.createElement("div", {
        style: {
          display: 'flex',
          alignItems: 'center',
          gap: '6px',
        ...
        size: 13
      }), /*#__PURE__*/React.createElement("span", null, customer?.firstName, " ", customer?.lastName)), /*#__PURE__*/React.createElement("div", {
        style: {
          display: 'flex',
          alignItems: 'center',
          gap: '6px',
        ...
        size: 13
      }), /*#__PURE__*/React.createElement("span", null, vehicle?.licensePlate)), wo.symptoms.length > 0 && /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: '11px',
          color: '#86868b',
          fontStyle: 'italic',
      ...
      }, wo.symptoms[0]), /*#__PURE__*/React.createElement("div", {
        style: {
          display: 'flex',
          justifyContent: 'space-between',
          alignItems: 'center',
        ...
        size: 14
      })), ['DIAGNOSIS', 'IN_PROGRESS', 'QUALITY_CHECK'].includes(wo.stage) && /*#__PURE__*/React.createElement("button", {
        onClick: e => {
          e.stopPropagation();
      ...
      }, /*#__PURE__*/React.createElement(Tablet, {
        size: 12,
        color: "#0071e3"
      }), /*#__PURE__*/React.createElement("span", null, "Bay Mode")), ['QUOTE', 'AWAITING_APPROVAL'].includes(wo.stage) && /*#__PURE__*/React.createElement("button", {
        onClick: e => {
          e.stopPropagation();
          onOpenQuotes(wo.id);
        },
        ...
        size: 12,
        color: "#bf5af2"
      }), /*#__PURE__*/React.createElement("span", null, "Quote")), ['READY', 'DELIVERED', 'INVOICED'].includes(wo.stage) && /*#__PURE__*/React.createElement("button", {
        onClick: e => {
          e.stopPropagation();
        ...
        size: 12,
        color: "#30d158"
      }), /*#__PURE__*/React.createElement("span", null, "Invoice")), /*#__PURE__*/React.createElement("button", {
        onClick: e => {
          e.stopPropagation();
  ...
  })), selectedOrder && /*#__PURE__*/React.createElement("div", {
    className: "apple-modal-overlay",
  ...
  }, selectedOrder.stage), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontSize: '22px',
      fontWeight: 700,
      color: '#1d1d1f'
    }
  }, "Work Order: ", selectedOrder.orderNumber)), /*#__PURE__*/React.createElement("button", {
    onClick: () => setSelectedOrder(null),
    className: "apple-btn-secondary"
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Customer:"), " ", customers.find(c => c.id === selectedOrder.customerId)?.firstName, " ", customers.find(c => c.id === selectedOrder.customerId)?.lastName), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Vehicle:"), " ", vehicles.find(v => v.id === selectedOrder.vehicleId)?.make, " ", vehicles.find(v => v.id === selectedOrder.vehicleId)?.model, " (", vehicles.find(v => v.id === selectedOrder.vehicleId)?.licensePlate, ")"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Technician:"), " ", mechanics.find(m => m.id === selectedOrder.mechanicId)?.name || 'Assigned'), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Labor Recorded:"), " ", selectedOrder.laborTimeRecordedMin, " mins")), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h4", {
    style: {
      fontWeight: 600,
      marginBottom: '6px'
    }
  }, "Reported Symptoms:"), /*#__PURE__*/React.createElement("ul", {
    style: {
      paddingLeft: '20px',
      color: '#6e6e73'
    }
  }, selectedOrder.symptoms.map((s, i) => /*#__PURE__*/React.createElement("li", {
    key: i
  }, s)))), selectedOrder.diagnosisNotes && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h4", {
    style: {
      fontWeight: 600,
      marginBottom: '6px'
    }
  }, "Technician Findings:"), /*#__PURE__*/React.createElement("p", {
    style: {
      background: '#ffffff',
      border: '1px solid #e5e5ea',
      padding: '10px',
  ...
  }, selectedOrder.diagnosisNotes)), selectedOrder.obdCodes.length > 0 && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h4", {
    style: {
      fontWeight: 600,
      marginBottom: '6px'
    }
  }, "Logged OBD-II Codes:"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '8px',
      flexWrap: 'wrap'
    }
  }, selectedOrder.obdCodes.map((c, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    className: "apple-badge apple-badge-red",
    style: {
      fontSize: '12px'
    }
  }, c.code, ": ", c.description)))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '10px',
      marginTop: '10px',
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Open in Mechanic Tablet Mode")), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      const id = selectedOrder.id;
      setSelectedOrder(null);
      onOpenQuotes(id);
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Manage Quote & Approval")), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      const id = selectedOrder.id;
      setSelectedOrder(null);
      onOpenInvoices(id);
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "View / Issue Invoice")))))));
};

// --- FILE: components/MechanicTabletMode.tsx ---
// ==========================================================================
// AtelierOS - Tablet-First Mechanic Bay Station Mode (iPad Optimized)
// ==========================================================================

const COMMON_OBD_DATABASE = {
  P0300: {
    desc: 'Random/Multiple Cylinder Misfire Detected',
    check: 'Test ignition coils, spark plugs, and injector pulse signals.'
  },
  P0420: {
    desc: 'Catalyst System Efficiency Below Threshold (Bank 1)',
    check: 'Inspect downstream O2 sensor output and catalytic converter integrity.'
  },
  P0171: {
    desc: 'System Too Lean (Bank 1)',
    check: 'Check MAF sensor, intake vacuum leaks, and fuel pump pressure.'
  },
  C0035: {
    desc: 'Left Front Wheel Speed Sensor Circuit',
    check: 'Inspect ABS reluctor ring, wiring harness, and sensor resistance.'
  },
  P0A80: {
    desc: 'Replace Hybrid / EV Battery Pack',
    check: 'Check individual cell module voltages, cooling fan, and contactor relays.'
  }
};
const MechanicTabletMode = ({
  ...
  const saveCurrentOrder = updated => {
    const all = StorageService.getAllWorkOrders();
  ...
  const toggleChecklist = (checkId, status) => {
    if (!currentOrder) return;
    const updatedChecklist = currentOrder.checklist.map(item => item.id === checkId ? {
      ...item,
      status
    } : item);
    saveCurrentOrder({
  ...
  const handleAddLaborMinutes = mins => {
    if (!currentOrder) return;
    const updated = {
      ...currentOrder,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, tm.title), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '12px',
      color: '#6e6e73'
    }
  }, "Station Active: ", /*#__PURE__*/React.createElement("strong", null, activeTenant.name), " \u2022 Touch-Optimized"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: '12px'
  ...
  }, "Active Vehicle:"), /*#__PURE__*/React.createElement("select", {
    ...
    size: 18
  }), /*#__PURE__*/React.createElement("span", null, "Work Order Updated")), currentOrder && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))',
      gap: '20px'
  ...
  }, currentOrder.orderNumber), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontSize: '24px',
      fontWeight: 800,
      color: '#1d1d1f'
    }
  }, vehicle?.make, " ", vehicle?.model, " (", vehicle?.year, ")"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '18px',
      fontWeight: 700,
      color: '#0071e3',
  ...
  }, currentOrder.stage))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      gap: '10px',
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "VIN:"), " ", vehicle?.vin), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Fuel:"), " ", vehicle?.fuelType), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Odometer:"), " ", vehicle?.mileage?.toLocaleString(), " km"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Customer:"), " ", customer?.firstName, " ", customer?.lastName)), currentOrder.symptoms.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '16px'
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Client Reported Symptoms:"), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#fff',
      border: '1px solid #e5e5ea',
      padding: '12px',
  ...
  }, currentOrder.symptoms.join(', ')))), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      padding: '24px'
    }
  ...
  }, "Technician Diagnostic Notes")), /*#__PURE__*/React.createElement("textarea", {
  ...
  }, tm.obdScannerTitle)), /*#__PURE__*/React.createElement("form", {
    onSubmit: handleAddObdCode,
    style: {
      display: 'flex',
      gap: '8px',
      marginBottom: '16px'
  ...
  }, tm.addCode)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '10px'
    }
  }, currentOrder.obdCodes.map((code, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    style: {
  ...
  }, code.description), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '12px',
      color: '#6e6e73',
      marginTop: '4px'
    }
  }, /*#__PURE__*/React.createElement("strong", null, "Action:"), " ", code.suggestedCheck)))))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '20px'
  ...
  }, tm.checklistTitle)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '12px'
    }
  }, currentOrder.checklist.map(item => /*#__PURE__*/React.createElement("div", {
    key: item.id,
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, item.title), item.notes && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '11px',
      color: '#86868b'
    }
  ...
  }, tm.recordLaborTime)), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '20px',
      fontWeight: 800,
      color: '#0071e3'
    }
  }, currentOrder.laborTimeRecordedMin || 0, " min")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '8px'
    }
  }, [15, 30, 45, 60].map(mins => /*#__PURE__*/React.createElement("button", {
    key: mins,
    type: "button",
  ...
  }, "+", mins, "m")))), /*#__PURE__*/React.createElement("div", {
    style: {
      borderTop: '1px solid #e5e5ea',
      paddingTop: '16px'
    }
  ...
  }, tm.partsTrackerTitle), /*#__PURE__*/React.createElement("form", {
  ...
  }, tm.addPart))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '6px'
    }
  }, currentOrder.partsUsed.map((p, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    style: {
      display: 'flex',
      justifyContent: 'space-between',
  ...
  }, /*#__PURE__*/React.createElement("span", null, p.quantity, "x ", p.name), /*#__PURE__*/React.createElement("span", {
    style: {
      fontWeight: 700
    }
  }, p.total.toFixed(2), " ", activeTenant.currency)))))), /*#__PURE__*/React.createElement("button", {
    ...
    size: 22
  }), /*#__PURE__*/React.createElement("span", null, tm.signOffQuality)))));
};

// --- FILE: components/CustomerDirectory.tsx ---
// ==========================================================================
...
const CustomerDirectory = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Customer Directory"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '14px',
      color: '#6e6e73'
    }
  }, "France & Switzerland customer registry with GDPR consent and tax identities.")), /*#__PURE__*/React.createElement("button", {
    onClick: openNewCustomerModal,
    className: "apple-btn-primary"
  }, /*#__PURE__*/React.createElement(UserPlus, {
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "+ Add New Customer"))), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      padding: '16px 20px',
      marginBottom: '20px',
  ...
  }, ['ALL', 'INDIVIDUAL', 'BUSINESS'].map(type => /*#__PURE__*/React.createElement("button", {
    key: type,
  ...
  }, "Customer Name / Company"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px'
    }
  }, "Contact Info"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px'
    }
  }, "Country / Tax ID"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px'
    }
  }, "GDPR Consent"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px',
      textAlign: 'right'
    }
  ...
  }, c.firstName, " ", c.lastName), c.companyName && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '12px',
      color: '#0071e3',
      display: 'flex',
    ...
    size: 12
  }), /*#__PURE__*/React.createElement("span", null, c.companyName)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '11px',
      color: '#86868b',
      marginTop: '2px'
    }
  }, c.address.street, ", ", c.address.postalCode, " ", c.address.city)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '16px 20px'
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    size: 13,
    color: "#0071e3"
  }), /*#__PURE__*/React.createElement("span", null, c.phone)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: '6px',
    ...
    size: 13
  }), /*#__PURE__*/React.createElement("span", null, c.email))), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '16px 20px'
    }
  }, /*#__PURE__*/React.createElement("span", {
    className: `apple-badge ${c.country === 'FR' ? 'apple-badge-blue' : 'apple-badge-amber'}`,
    style: {
      marginBottom: '4px'
    }
  }, c.country === 'FR' ? 'France (FR)' : 'Switzerland (CH)'), c.taxIdentity?.siret && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '11px',
      color: '#6e6e73'
    }
  }, "SIRET: ", c.taxIdentity.siret), c.taxIdentity?.uid && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '11px',
      color: '#6e6e73'
    }
  }, "UID: ", c.taxIdentity.uid)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '16px 20px'
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Opted-in (SMS/Email)"))), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '16px 20px',
      textAlign: 'right'
    }
    ...
    size: 14
  })))))))))), isEditModalOpen && /*#__PURE__*/React.createElement("div", {
    className: "apple-modal-overlay",
  ...
  }, editingCustomer ? 'Edit Customer Details' : 'Register New Customer'), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13px',
      color: '#6e6e73',
      marginBottom: '20px'
    }
  }, "Structure identity, country format, and tax registry."), /*#__PURE__*/React.createElement("form", {
    onSubmit: e => {
      e.preventDefault();
  ...
  }, "Customer Classification"), /*#__PURE__*/React.createElement("select", {
    value: formType,
    ...
    value: "INDIVIDUAL"
  }, "Individual (B2C)"), /*#__PURE__*/React.createElement("option", {
    value: "BUSINESS"
  }, "Business / Corporate (B2B)"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
    ...
    value: "FR"
  }, "France (FR)"), /*#__PURE__*/React.createElement("option", {
    value: "CH"
  }, "Switzerland (CH)")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      gap: '10px'
  ...
  }))), formType === 'BUSINESS' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
  ...
  })), formCountry === 'FR' ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
  ...
  }, "French SIRET (14 digits)"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: formSiret,
  ...
  }, "Swiss UID / IDE (CHE-xxx.xxx.xxx)"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: formUid,
    ...
    type: "submit",
    className: "apple-btn-primary"
  }, "Save Customer"))))), /*#__PURE__*/React.createElement(ConfirmationModal, {
...
// --- FILE: components/VehicleDirectory.tsx ---
// ==========================================================================
...
const VehicleDirectory = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Vehicle Registry"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '14px',
      color: '#6e6e73'
    }
  }, "Customer vehicles, technical specifications, VIN lookup, and service mileage history.")), /*#__PURE__*/React.createElement("button", {
    onClick: openNewVehicleModal,
    className: "apple-btn-primary"
  }, /*#__PURE__*/React.createElement(Plus, {
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "+ Register New Vehicle"))), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      padding: '16px 20px',
      marginBottom: '20px'
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, veh.licensePlate), /*#__PURE__*/React.createElement("h3", {
      style: {
        fontSize: '18px',
        fontWeight: 700,
        color: '#1d1d1f',
    ...
    }, veh.make, " ", veh.model)), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        gap: '6px'
      }
      ...
      onClick: () => setConfirmDeleteVehicle(veh),
      className: "apple-btn-danger",
      style: {
        padding: '6px 8px',
        minHeight: '30px'
    ...
    }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Year:"), " ", veh.year), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Fuel:"), " ", veh.fuelType), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Trans:"), " ", veh.transmission), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Mileage:"), " ", veh.mileage?.toLocaleString(), " km"), /*#__PURE__*/React.createElement("div", {
      style: {
        gridColumn: 'span 2',
        fontSize: '11px',
        color: '#6e6e73'
      }
    }, /*#__PURE__*/React.createElement("strong", null, "VIN:"), " ", veh.vin)), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        alignItems: 'center',
        gap: '6px',
    ...
    }, "Owner: ", owner?.firstName, " ", owner?.lastName)), veh.notes && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '12px',
        color: '#6e6e73',
        fontStyle: 'italic'
  ...
  }, editingVehicle ? 'Edit Vehicle' : 'Register Vehicle'), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13px',
      color: '#6e6e73',
      marginBottom: '20px'
    }
  }, "Record technical details, owner link, and license plate."), /*#__PURE__*/React.createElement("form", {
  ...
  }, "Registered Owner"), /*#__PURE__*/React.createElement("select", {
    value: formCustomerId,
    onChange: e => setFormCustomerId(e.target.value),
    required: true,
    style: {
    ...
    key: c.id,
    value: c.id
  }, c.firstName, " ", c.lastName, " (", c.phone, ")")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      gap: '10px'
  ...
  }, "License Plate"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: formPlate,
  ...
  }, "VIN (17 Characters)"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: formVin,
  ...
  }, "Make (Manufacturer)"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: formMake,
  ...
  }, "Fuel"), /*#__PURE__*/React.createElement("select", {
    value: formFuel,
    ...
    value: "ELECTRIC"
  }, "Electric (EV)"), /*#__PURE__*/React.createElement("option", {
    value: "HYBRID"
  }, "Hybrid"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
  ...
  }, "Mileage (km)"), /*#__PURE__*/React.createElement("input", {
    type: "number",
    value: formMileage,
    ...
    type: "submit",
    className: "apple-btn-primary"
  }, "Save Vehicle"))))), /*#__PURE__*/React.createElement(ConfirmationModal, {
...
const QuoteManager = ({
  ...
  const handleUpdateLine = (id, field, val) => {
  ...
  const handleSendMagicLink = quote => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, tq.title), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '14px',
      color: '#6e6e73'
    }
  }, tq.subtitle)), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, tq.createQuote))), sentToast && /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#30d158',
      color: '#ffffff',
      padding: '14px 20px',
    ...
    size: 18
  }), /*#__PURE__*/React.createElement("span", null, sentToast)), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      overflow: 'hidden'
    }
  ...
  }, "Quote #"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px'
    }
  }, "Customer & Vehicle"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px'
    }
  ...
  }, "Approval Status"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px'
    }
  }, "Magic Link Actions"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px',
      textAlign: 'right'
    }
  }, "Actions"))), /*#__PURE__*/React.createElement("tbody", null, quotes.map(q => {
    ...
    return /*#__PURE__*/React.createElement("tr", {
    ...
    }, q.quoteNumber), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '11px',
        color: '#86868b',
        marginTop: '2px'
      }
    }, "Valid: ", q.validUntil)), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '16px 20px'
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, customer?.firstName, " ", customer?.lastName), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '12px',
        color: '#6e6e73',
        display: 'flex',
      ...
      size: 12
    }), /*#__PURE__*/React.createElement("span", null, vehicle?.make, " ", vehicle?.model, " (", vehicle?.licensePlate, ")"))), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '16px 20px'
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, q.totalAmount.toFixed(2), " ", q.currency), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '11px',
        color: '#86868b'
      }
    }, "(HT: ", q.subtotalExclVat.toFixed(2), " + TVA: ", q.totalVat.toFixed(2), ")")), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '16px 20px'
      }
    }, /*#__PURE__*/React.createElement("span", {
      className: `apple-badge ${q.status === 'APPROVED' ? 'apple-badge-green' : q.status === 'REJECTED' ? 'apple-badge-red' : 'apple-badge-amber'}`
    }, q.status), q.approvalSignature && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '11px',
        color: '#30d158',
        marginTop: '4px',
    ...
    }, "Signed: ", q.approvalSignature)), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '16px 20px'
      }
    }, /*#__PURE__*/React.createElement("div", {
      ...
      size: 12,
      color: "#0071e3"
    }), /*#__PURE__*/React.createElement("span", null, "Dispatch Link")), /*#__PURE__*/React.createElement("button", {
    ...
    }, copiedToken === q.magicToken ? /*#__PURE__*/React.createElement(Check, {
      size: 13,
      color: "#30d158"
    ...
    }, onOpenCustomerApproval && /*#__PURE__*/React.createElement("button", {
      ...
      size: 13
    }), /*#__PURE__*/React.createElement("span", null, "Preview Portal")), q.status === 'APPROVED' && onOpenInvoice && /*#__PURE__*/React.createElement("button", {
    ...
    }, /*#__PURE__*/React.createElement("span", null, "Generate Invoice")))));
  }))))), isBuilderOpen && /*#__PURE__*/React.createElement("div", {
    className: "apple-modal-overlay",
  ...
  }, "Interactive Quotation Builder"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13px',
      color: '#6e6e73',
      marginBottom: '20px'
    }
  }, "Add labor and spare parts. Tax is deterministically calculated per country & customer profile."), /*#__PURE__*/React.createElement("form", {
  ...
  }, "Target Work Order"), /*#__PURE__*/React.createElement("select", {
  ...
  }, "Itemized Labor & Parts"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '6px'
    }
    ...
    type: "button",
    onClick: () => handleAddLine('LABOR'),
    className: "apple-btn-secondary",
    style: {
      padding: '4px 10px',
      fontSize: '12px'
    }
  }, "+ Add Labor"), /*#__PURE__*/React.createElement("button", {
    type: "button",
    ...
    type: "button",
    onClick: () => handleAddLine('CONSUMABLE'),
    className: "apple-btn-secondary",
    style: {
      padding: '4px 10px',
      fontSize: '12px'
    }
  }, "+ Add Consumable"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '8px'
    }
  }, builderLines.map(line => /*#__PURE__*/React.createElement("div", {
    key: line.id,
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 80px 100px 70px 30px',
      gap: '8px',
      alignItems: 'center',
      background: '#f5f5f7',
      padding: '10px',
  ...
  }, line.vatRate, "% TVA"), /*#__PURE__*/React.createElement("button", {
    type: "button",
  ...
  }, "Subtotal HT: ", /*#__PURE__*/React.createElement("strong", null, builderTotals.subtotalExclVat.toFixed(2), " ", activeTenant.currency)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '13px',
      color: '#6e6e73'
    }
  }, "Total TVA (", activeTenant.settings.standardVatRate, "%): ", /*#__PURE__*/React.createElement("strong", null, builderTotals.totalVat.toFixed(2), " ", activeTenant.currency))), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'right'
    }
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, "Total TTC"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '24px',
      fontWeight: 800,
      color: '#1d1d1f'
    }
  }, builderTotals.totalAmount.toFixed(2), " ", activeTenant.currency))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'flex-end',
      gap: '10px',
...
const InvoiceManager = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, ti.title), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '14px',
      color: '#6e6e73'
    }
  }, ti.subtitle)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '10px'
    }
  ...
  }, invoices.length, " Invoices Issued"))), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      overflow: 'hidden'
    }
  ...
  }, "E-Invoicing (Chorus Pro)"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px',
      textAlign: 'right'
    }
  }, "Actions"))), /*#__PURE__*/React.createElement("tbody", null, invoices.map(inv => {
    ...
    return /*#__PURE__*/React.createElement("tr", {
    ...
    }, inv.invoiceNumber), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '11px',
        color: '#86868b',
        marginTop: '2px'
      }
    }, "Issued: ", inv.issueDate, " \u2022 Due: ", inv.dueDate)), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '16px 20px'
      }
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, inv.totalAmount.toFixed(2), " ", inv.currency), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: '11px',
        color: '#86868b'
      }
    }, "(HT: ", inv.subtotalExclVat.toFixed(2), " + TVA: ", inv.totalVat.toFixed(2), ")")), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '16px 20px'
      }
    }, /*#__PURE__*/React.createElement("button", {
    ...
    }, inv.paid ? 'PAID / RÉGLÉ' : 'UNPAID')), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '16px 20px'
      }
    }, /*#__PURE__*/React.createElement("div", {
      ...
      className: `apple-badge ${inv.eInvoiceStatus === 'ACCEPTED' ? 'apple-badge-green' : inv.eInvoiceStatus === 'SUBMITTED' ? 'apple-badge-blue' : 'apple-badge-neutral'}`
    }, inv.eInvoiceStatus), inv.eInvoiceSubmissionId && /*#__PURE__*/React.createElement("span", {
      style: {
        fontSize: '11px',
        color: '#86868b'
      }
    }, inv.eInvoiceSubmissionId.substring(0, 10), "..."))), /*#__PURE__*/React.createElement("td", {
      style: {
        padding: '16px 20px',
        textAlign: 'right'
      }
      ...
      size: 13
    }), /*#__PURE__*/React.createElement("span", null, "PDF")), /*#__PURE__*/React.createElement("button", {
      ...
      size: 13
    }), /*#__PURE__*/React.createElement("span", null, "E-Invoice")))));
  }))))), isPrintViewOpen && selectedInvoice && /*#__PURE__*/React.createElement("div", {
    className: "apple-modal-overlay",
  ...
  }, "Invoice Preview: ", selectedInvoice.invoiceNumber), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '10px'
    }
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Print / Save as PDF")), /*#__PURE__*/React.createElement("button", {
    onClick: () => setIsPrintViewOpen(false),
    className: "apple-btn-secondary"
  }, "Close"))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, activeTenant.name), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '12px',
      color: '#6e6e73',
      marginTop: '4px'
    }
  }, activeTenant.address.street, /*#__PURE__*/React.createElement("br", null), activeTenant.address.postalCode, " ", activeTenant.address.city, ", ", activeTenant.country, /*#__PURE__*/React.createElement("br", null), "Phone: ", activeTenant.phone, " \u2022 Email: ", activeTenant.email), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '11px',
      color: '#86868b',
      marginTop: '6px'
    }
  }, activeTenant.country === 'FR' ? `SIRET: ${activeTenant.taxIdentity.siret} • N° TVA: ${activeTenant.taxIdentity.vatNumber}` : `IDE/UID: ${activeTenant.taxIdentity.uid}`)), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'right'
    }
  }, /*#__PURE__*/React.createElement("h2", {
  ...
  }, "FACTURE / INVOICE"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '14px',
      fontWeight: 700,
      marginTop: '4px'
    }
  }, selectedInvoice.invoiceNumber), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '12px',
      color: '#6e6e73',
      marginTop: '4px'
    }
  }, "Date: ", selectedInvoice.issueDate, /*#__PURE__*/React.createElement("br", null), "Due Date: ", selectedInvoice.dueDate))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#f5f5f7',
      padding: '16px 20px',
      borderRadius: '12px',
  ...
  }, "Bill To / Client :"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '16px',
      fontWeight: 700,
      color: '#1d1d1f',
  ...
  }, customers.find(c => c.id === selectedInvoice.customerId)?.companyName || `${customers.find(c => c.id === selectedInvoice.customerId)?.firstName} ${customers.find(c => c.id === selectedInvoice.customerId)?.lastName}`), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '13px',
      color: '#6e6e73',
      marginTop: '2px'
    }
  }, customers.find(c => c.id === selectedInvoice.customerId)?.address.street, /*#__PURE__*/React.createElement("br", null), customers.find(c => c.id === selectedInvoice.customerId)?.address.postalCode, " ", customers.find(c => c.id === selectedInvoice.customerId)?.address.city)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '11px',
      fontWeight: 700,
      color: '#86868b',
  ...
  }, "Vehicle Serviced :"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '15px',
      fontWeight: 700,
      color: '#0071e3',
  ...
  }, vehicles.find(v => v.id === selectedInvoice.vehicleId)?.licensePlate), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '13px',
      color: '#6e6e73'
    }
  }, vehicles.find(v => v.id === selectedInvoice.vehicleId)?.make, " ", vehicles.find(v => v.id === selectedInvoice.vehicleId)?.model))), /*#__PURE__*/React.createElement("table", {
    style: {
      width: '100%',
      borderCollapse: 'collapse',
      marginBottom: '24px',
  ...
  }, "Unit Price HT"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '8px 10px',
      textAlign: 'center'
    }
  }, "TVA %"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '8px 0',
      textAlign: 'right'
    }
  }, "Total HT"))), /*#__PURE__*/React.createElement("tbody", null, selectedInvoice.lines.map((l, idx) => /*#__PURE__*/React.createElement("tr", {
    key: idx,
    style: {
      borderBottom: '1px solid #e5e5ea'
    }
  ...
  }, l.description), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '10px 10px',
      textAlign: 'center'
    }
  }, l.quantity), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '10px 10px',
      textAlign: 'right'
    }
  }, l.unitPrice.toFixed(2), " ", selectedInvoice.currency), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '10px 10px',
      textAlign: 'center'
    }
  }, l.vatRate, "%"), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '10px 0',
      textAlign: 'right',
      fontWeight: 600
    }
  }, l.totalExclVat.toFixed(2), " ", selectedInvoice.currency))))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      alignItems: 'flex-start',
  ...
  }, "Tax Treatment & Legal Basis:"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '12px',
      color: '#1d1d1f',
      marginTop: '2px'
    }
  }, selectedInvoice.taxTreatment), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '11px',
      color: '#86868b',
      marginTop: '8px'
    }
  }, "IBAN: ", activeTenant.taxIdentity.iban || 'FR76 XXXX XXXX', /*#__PURE__*/React.createElement("br", null), "BIC/SWIFT: ", activeTenant.taxIdentity.bic || 'BNPAFRPPXXX')), /*#__PURE__*/React.createElement("div", {
    style: {
      width: '280px',
      display: 'flex',
      flexDirection: 'column',
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Subtotal HT:"), /*#__PURE__*/React.createElement("strong", null, selectedInvoice.subtotalExclVat.toFixed(2), " ", selectedInvoice.currency)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      fontSize: '13px'
    }
  }, /*#__PURE__*/React.createElement("span", null, "Total TVA:"), /*#__PURE__*/React.createElement("strong", null, selectedInvoice.totalVat.toFixed(2), " ", selectedInvoice.currency)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      fontSize: '18px',
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Total TTC:"), /*#__PURE__*/React.createElement("span", null, selectedInvoice.totalAmount.toFixed(2), " ", selectedInvoice.currency)))), activeTenant.country === 'CH' && selectedInvoice.qrBillReference && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '36px',
  ...
  }, /*#__PURE__*/React.createElement("strong", null, "Swiss QR-Bill Reference (Section paiement)"), /*#__PURE__*/React.createElement("br", null), "Compte / Zahlbar an: ", activeTenant.taxIdentity.iban, /*#__PURE__*/React.createElement("br", null), "R\xE9f\xE9rence: ", selectedInvoice.qrBillReference, /*#__PURE__*/React.createElement("br", null), "Payable par: ", customers.find(c => c.id === selectedInvoice.customerId)?.firstName, " ", customers.find(c => c.id === selectedInvoice.customerId)?.lastName)), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'right'
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Montant / Betrag"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '18px',
      fontWeight: 800
    }
  }, "CHF ", selectedInvoice.totalAmount.toFixed(2))))))), /*#__PURE__*/React.createElement(EInvoiceModal, {
...
// --- FILE: components/EInvoiceModal.tsx ---
// ==========================================================================
...
const EInvoiceModal = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "E-Invoicing Connector"), /*#__PURE__*/React.createElement("span", {
    className: "apple-badge apple-badge-blue",
    style: {
      fontSize: '11px'
    }
  }, payload.specification)), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13px',
      color: '#6e6e73'
    }
  }, "Invoice: ", /*#__PURE__*/React.createElement("strong", null, invoice.invoiceNumber), " \u2022 Compliant with French PPF / PDP Standard"))), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      background: 'none',
      border: 'none',
    ...
    id: 'SUMMARY',
    label: 'Structured Payload Summary'
  }, {
    id: 'XML',
    label: 'Inspect Factur-X / UBL XML'
  }, {
    id: 'SUBMISSION',
    label: 'Transmit & Live Status'
  ...
  }, tab.label))), activeTab === 'SUMMARY' && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '16px',
  ...
  }, "Seller (Workshop)"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Company:"), " ", payload.seller.name), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "SIRET / UID:"), " ", payload.seller.siret), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "VAT:"), " ", payload.seller.vatNumber || 'FRxx'), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Address:"), " ", payload.seller.address)), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#f5f5f7',
      padding: '16px',
      borderRadius: '12px'
  ...
  }, "Buyer (Customer)"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Name:"), " ", payload.buyer.name), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Legal ID:"), " ", payload.buyer.siretOrUid || 'B2C'), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Country:"), " ", payload.buyer.country), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Address:"), " ", payload.buyer.address))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#f5f5f7',
      padding: '16px',
      borderRadius: '12px'
  ...
  }, "Tax & Financial Breakdown"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr 1fr',
      gap: '10px'
    }
  }, /*#__PURE__*/React.createElement("div", null, "Total Excl. Tax: ", /*#__PURE__*/React.createElement("strong", null, payload.financials.subtotalExclTax.toFixed(2), " ", payload.financials.currency)), /*#__PURE__*/React.createElement("div", null, "Total VAT: ", /*#__PURE__*/React.createElement("strong", null, payload.financials.vatTotal.toFixed(2), " ", payload.financials.currency)), /*#__PURE__*/React.createElement("div", null, "Total Payable: ", /*#__PURE__*/React.createElement("strong", null, payload.financials.grandTotal.toFixed(2), " ", payload.financials.currency))))), activeTab === 'XML' && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      alignItems: 'center',
  ...
  }, "Standard: Factur-X / CII EN16931 Schema"), /*#__PURE__*/React.createElement("button", {
    ...
    size: 13
  }), /*#__PURE__*/React.createElement("span", null, copied ? 'Copied' : 'Copy XML'))), /*#__PURE__*/React.createElement("pre", {
    style: {
      background: '#1d1d1f',
      color: '#64d2ff',
      padding: '16px',
  ...
  }, payload.xmlPreview)), activeTab === 'SUBMISSION' && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '16px'
  ...
  }, "Select French E-Invoicing Platform"), /*#__PURE__*/React.createElement("select", {
    value: platform,
    ...
    value: "CHORUS_PRO"
  }, "Chorus Pro (Portail Public de Facturation - B2G & B2B)"), /*#__PURE__*/React.createElement("option", {
    value: "PPF"
  }, "PPF Native Direct API"), /*#__PURE__*/React.createElement("option", {
    value: "PDP_GENERIC"
  }, "Partner PDP Dematerialization Platform"))), submissionResult ? /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    size: 20
  }), /*#__PURE__*/React.createElement("span", null, "Submission Accepted & Recorded")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '13px',
      color: '#1d1d1f',
      lineHeight: 1.5
    }
  }, submissionResult.message), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '10px',
      fontSize: '12px',
      color: '#6e6e73'
    }
  }, "External Transaction Reference: ", /*#__PURE__*/React.createElement("strong", null, submissionResult.submissionId))) : /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '20px 0'
    }
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Transmit Electronic Payload to ", platform)))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '24px',
      display: 'flex',
      justifyContent: 'flex-end'
...
// --- FILE: components/CustomerBookingPortal.tsx ---
// ==========================================================================
...
const CustomerBookingPortal = ({
  ...
  }, "Official Online Booking"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: '26px',
      fontWeight: 800,
      color: '#1d1d1f'
    }
  }, activeTenant.name), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13px',
      color: '#6e6e73',
      marginTop: '4px'
    }
  }, activeTenant.address.street, ", ", activeTenant.address.city, " \u2022 Phone: ", activeTenant.phone)), confirmedCode ?
  /*#__PURE__*/
  /* Confirmation Screen */
  React.createElement("div", {
  ...
  }, tb.successTitle), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '14px',
      color: '#6e6e73',
      marginBottom: '24px'
    }
  }, "Your appointment has been registered directly into our central workshop agenda."), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#f5f5f7',
      padding: '20px',
      borderRadius: '16px',
  ...
  }, tb.successRef), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '28px',
      fontWeight: 800,
      color: '#0071e3',
  ...
  }, confirmedCode), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '13px',
      color: '#1d1d1f',
      marginTop: '8px'
    }
  }, "Date: ", /*#__PURE__*/React.createElement("strong", null, selectedSlot?.date), " (", selectedSlot?.startTime, " - ", selectedSlot?.endTime, ")")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
    ...
    size: 18
  }), /*#__PURE__*/React.createElement("span", null, tb.smsNotice)), /*#__PURE__*/React.createElement("button", {
    onClick: () => {
      setStep(1);
  ...
  React.createElement("div", {
  ...
  }, activeHoldId && /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'rgba(0, 113, 227, 0.08)',
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Temporary Slot Reservation Active:")), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '15px',
      fontWeight: 800
    }
  }, formatTimer(holdCountdownSeconds))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      marginBottom: '28px',
  ...
  }, [tb.step1, tb.step2, tb.step3, tb.step4].map((label, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    style: {
      fontSize: '12px',
  ...
  }, label.split('. ')[1])))), step === 1 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '16px'
  ...
  }, tb.step1), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '13px',
      fontWeight: 600,
  ...
  }, "License Plate / Immatriculation"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: plate,
  ...
  }, "Vehicle Make & Model"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: makeModel,
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Continue to Service Selection"), /*#__PURE__*/React.createElement(ArrowRight, {
    size: 16
  ...
  }, tb.step2), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '10px'
  ...
  }, "Estimated Duration: ~", s.estimatedDurationMin, " minutes")), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'right'
    }
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, s.baseLaborPrice.toFixed(2), " ", activeTenant.currency))))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      marginTop: '16px'
    ...
    onClick: () => setStep(3),
    className: "apple-btn-primary"
  }, /*#__PURE__*/React.createElement("span", null, "Choose Date & Time"), /*#__PURE__*/React.createElement(ArrowRight, {
    size: 16
  ...
  }, tb.step3), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '13px',
      fontWeight: 600,
  ...
  }, "Select Preferred Date"), /*#__PURE__*/React.createElement("input", {
    type: "date",
    value: selectedDate,
  ...
  }, "Available Live Slots (Central Agenda):"), availableSlots.length === 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '24px',
      background: '#f5f5f7',
  ...
  }, "No slots available for this date. Please choose another day.") : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
    ...
    className: "apple-btn-primary"
  }, /*#__PURE__*/React.createElement("span", null, "Confirm Contact Details"), /*#__PURE__*/React.createElement(ArrowRight, {
    size: 16
  })))), step === 4 && /*#__PURE__*/React.createElement("form", {
    onSubmit: handleFinalConfirmBooking,
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '14px'
  ...
  }, tb.step4), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#f5f5f7',
      padding: '14px',
      borderRadius: '12px',
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Service:"), " ", selectedServiceObj?.name), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Slot:"), " ", selectedSlot?.date, " at ", selectedSlot?.startTime, " - ", selectedSlot?.endTime), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Vehicle:"), " ", plate, " (", makeModel, ")")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      gap: '10px'
  ...
  }, "Mobile Phone (For SMS Confirmation)"), /*#__PURE__*/React.createElement("input", {
    type: "tel",
    value: phone,
  ...
  }, "Email Address (For Calendar Invite)"), /*#__PURE__*/React.createElement("input", {
    type: "email",
    value: email,
  ...
  }, tb.consentGdpr)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      marginTop: '16px'
  ...
  }, /*#__PURE__*/React.createElement("span", null, tb.confirmBooking))))));
};

// --- FILE: components/CustomerApprovalPortal.tsx ---
// ==========================================================================
...
const CustomerApprovalPortal = ({
  ...
  if (!quote || !tenant) {
    ...
    }, "Quote Link Not Found"), /*#__PURE__*/React.createElement("p", {
      style: {
        color: '#6e6e73',
        marginTop: '8px'
      }
    }, "This magic link may have expired or is invalid."));
  }
  return /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: '800px',
  ...
  }, "Customer Approval Portal"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: '24px',
      fontWeight: 800,
      color: '#1d1d1f'
  ...
  }, tenant.address.street, ", ", tenant.address.city, " \u2022 Phone: ", tenant.phone)), actionDoneMessage && /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, quote.status === 'APPROVED' ? /*#__PURE__*/React.createElement(CheckCircle2, {
    size: 24
  }) : /*#__PURE__*/React.createElement(XCircle, {
    size: 24
  }), /*#__PURE__*/React.createElement("span", null, actionDoneMessage)), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      padding: '32px',
      marginBottom: '24px'
  ...
  }, "Quotation Reference:"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '22px',
      fontWeight: 800,
      color: '#0071e3',
  ...
  }, quote.quoteNumber), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '12px',
      color: '#6e6e73',
      marginTop: '4px'
    }
  }, "Valid until: ", quote.validUntil)), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'right'
    }
  }, /*#__PURE__*/React.createElement("span", {
    className: `apple-badge ${quote.status === 'APPROVED' ? 'apple-badge-green' : quote.status === 'REJECTED' ? 'apple-badge-red' : 'apple-badge-amber'}`,
    style: {
      fontSize: '13px',
      padding: '6px 14px'
    }
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Client:"), " ", customer?.firstName, " ", customer?.lastName), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("strong", null, "Vehicle:"), " ", vehicle?.make, " ", vehicle?.model, " (", /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#0071e3',
      fontWeight: 700
    }
  }, vehicle?.licensePlate), ")")), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontSize: '16px',
      fontWeight: 700,
      marginBottom: '12px',
  ...
  }, "Recommended Services & Parts"), /*#__PURE__*/React.createElement("table", {
    style: {
      width: '100%',
      borderCollapse: 'collapse',
      marginBottom: '24px',
  ...
  }, "Total HT"))), /*#__PURE__*/React.createElement("tbody", null, quote.lines.map((l, i) => /*#__PURE__*/React.createElement("tr", {
    key: i,
    style: {
      borderBottom: '1px solid #e5e5ea'
    }
  ...
  }, l.unitPrice.toFixed(2), " ", quote.currency), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '10px 0',
      textAlign: 'right',
      fontWeight: 600
    }
  }, l.totalExclVat.toFixed(2), " ", quote.currency))))), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#f9f9fb',
      padding: '16px 20px',
      borderRadius: '14px',
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Subtotal Excl. Tax (HT):"), /*#__PURE__*/React.createElement("strong", null, quote.subtotalExclVat.toFixed(2), " ", quote.currency)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      fontSize: '14px'
    }
  }, /*#__PURE__*/React.createElement("span", null, "TVA / Tax Total:"), /*#__PURE__*/React.createElement("strong", null, quote.totalVat.toFixed(2), " ", quote.currency)), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between',
      fontSize: '20px',
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Grand Total (TTC):"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#0071e3'
    }
  }, quote.totalAmount.toFixed(2), " ", quote.currency)))), quote.status === 'SENT_AWAITING_APPROVAL' && /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      padding: '32px'
    }
  }, !isRejecting ? /*#__PURE__*/React.createElement("form", {
  ...
  }, tap.authorizedBy)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '13px',
      fontWeight: 600,
  ...
  }, "Please type your Full Name as electronic signature:"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: signatureName,
    ...
    size: 18
  }), /*#__PURE__*/React.createElement("span", null, tap.approveBtn)), /*#__PURE__*/React.createElement("button", {
    type: "button",
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Decline Quote")))) : /*#__PURE__*/React.createElement("form", {
  ...
  }, "Decline Quotation"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '13px',
      fontWeight: 600,
  ...
  }, "Please provide a reason for the workshop manager:"), /*#__PURE__*/React.createElement("textarea", {
...
// --- FILE: components/CustomerTrackingPortal.tsx ---
// ==========================================================================
...
const CustomerTrackingPortal = ({
  ...
  const STAGES_PROGRESS = [{
    ...
    key: 'DIAGNOSIS',
    label: '2. Inspection & Diagnosis'
  }, {
    key: 'QUOTE',
    label: '3. Quote & Approval'
  }, {
    key: 'IN_PROGRESS',
    label: '4. Active Bay Repair'
  }, {
    key: 'QUALITY_CHECK',
    label: '5. Quality Inspection'
  }, {
    key: 'READY',
    label: '6. Ready for Collection'
  }];
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Live Repair Status Tracker"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontSize: '26px',
      fontWeight: 800,
      color: '#1d1d1f'
  ...
  }, "Track real-time workshop floor progress for your vehicle."), /*#__PURE__*/React.createElement("form", {
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Track")))), notFound && /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#fff',
      padding: '32px',
      borderRadius: '16px',
  ...
  }, "No active work order found for license plate ", /*#__PURE__*/React.createElement("strong", null, plateQuery), "."), activeOrder && /*#__PURE__*/React.createElement("div", {
    className: "apple-card animate-fade-in",
    style: {
      padding: '32px'
    }
  ...
  }, vehicle?.licensePlate), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontSize: '22px',
      fontWeight: 800,
      color: '#1d1d1f',
  ...
  }, "Order #", activeOrder.orderNumber, " \u2022 Client: ", customer?.firstName, " ", customer?.lastName)), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'right'
    }
  }, /*#__PURE__*/React.createElement("span", {
  ...
  }, activeOrder.stage))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: '32px'
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, STAGES_PROGRESS.map((stg, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      textAlign: 'center',
      flex: 1
  ...
  }, i < currentProgressIndex ? /*#__PURE__*/React.createElement(CheckCircle2, {
    size: 18
  }) : i + 1), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '11px',
      color: i <= currentProgressIndex ? '#1d1d1f' : '#86868b',
      fontWeight: i === currentProgressIndex ? 700 : 500
    }
  }, stg.label.split('. ')[1])))), /*#__PURE__*/React.createElement("div", {
    style: {
      height: '6px',
      background: '#e5e5ea',
      borderRadius: '9999px',
  ...
  }, "Completed Workshop Health Checkpoints:"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '8px'
    }
  }, activeOrder.checklist.map(item => /*#__PURE__*/React.createElement("div", {
    key: item.id,
    style: {
      display: 'flex',
      alignItems: 'center',
    ...
    className: `apple-badge ${item.status === 'PASS' ? 'apple-badge-green' : 'apple-badge-amber'}`
  }, item.status)))))));
};

// --- FILE: components/CommunicationsHub.tsx ---
// ==========================================================================
...
const CommunicationsHub = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Omnichannel Communications Hub"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '14px',
      color: '#6e6e73'
    }
  }, "Automated & direct SMS, Email, and WhatsApp dispatches with delivery tracking.")), /*#__PURE__*/React.createElement("span", {
    className: "apple-badge apple-badge-green",
    style: {
      fontSize: '13px',
      padding: '6px 14px'
    }
  }, "GDPR Opt-In Enforced")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, "Dispatch Customer Notification")), sentNotice && /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#30d158',
      color: '#ffffff',
      padding: '12px 16px',
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Message dispatched successfully")), /*#__PURE__*/React.createElement("form", {
    onSubmit: handleSend,
    style: {
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "Recipient Customer"), /*#__PURE__*/React.createElement("select", {
    ...
    key: c.id,
    value: c.id
  }, c.firstName, " ", c.lastName, " (", c.phone, " \u2022 ", c.email, ")")))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
  ...
  }, ['SMS', 'EMAIL', 'WHATSAPP'].map(ch => /*#__PURE__*/React.createElement("button", {
    key: ch,
    type: "button",
  ...
  }, ch)))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
  ...
  }, "Message Template Type"), /*#__PURE__*/React.createElement("select", {
    value: templateType,
  ...
  }, "Booking Confirmation"), /*#__PURE__*/React.createElement("option", {
    value: "REMINDER_24H"
  }, "24-Hour Appointment Reminder"), /*#__PURE__*/React.createElement("option", {
    value: "QUOTE_APPROVAL_LINK"
  }, "Quote Ready for Approval"), /*#__PURE__*/React.createElement("option", {
    value: "VEHICLE_READY"
  }, "Vehicle Ready for Collection"), /*#__PURE__*/React.createElement("option", {
    value: "INVOICE_ISSUED"
  }, "Invoice Issued & Available"), /*#__PURE__*/React.createElement("option", {
    value: "REVIEW_REQUEST"
  }, "Review & Feedback Request"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
  ...
  }, "Custom Message Override (Optional)"), /*#__PURE__*/React.createElement("textarea", {
    value: customBody,
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Dispatch Message")))), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      padding: '28px'
    }
  ...
  }, "Transmission History"), /*#__PURE__*/React.createElement("span", {
    className: "apple-badge apple-badge-neutral"
  }, logs.length, " logged")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: '12px',
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: `apple-badge ${log.channel === 'WHATSAPP' ? 'apple-badge-green' : log.channel === 'SMS' ? 'apple-badge-blue' : 'apple-badge-amber'}`,
      style: {
        fontSize: '10px'
      }
    }, log.channel), /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 600,
        fontSize: '13px',
        color: '#1d1d1f'
      }
    }, cust?.firstName, " ", cust?.lastName)), /*#__PURE__*/React.createElement("span", {
      className: "apple-badge apple-badge-green",
      style: {
        fontSize: '10px'
      }
    }, log.status)), /*#__PURE__*/React.createElement("p", {
      style: {
        fontSize: '12px',
        color: '#333336',
        lineHeight: 1.4,
    ...
    }, log.messageBody), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
        justifyContent: 'space-between',
        fontSize: '11px',
    ...
    }, /*#__PURE__*/React.createElement("span", null, "To: ", log.recipient), /*#__PURE__*/React.createElement("span", null, new Date(log.sentAt).toLocaleTimeString([], {
      hour: '2-digit',
      minute: '2-digit'
    }))));
  })))));
...
const SuperAdminDashboard = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, tsa.title), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '14px',
      color: '#6e6e73'
    }
  }, tsa.subtitle)), /*#__PURE__*/React.createElement("button", {
    onClick: () => setIsOnboardModalOpen(true),
    className: "apple-btn-primary"
  }, /*#__PURE__*/React.createElement(Plus, {
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, tsa.onboardGarage))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, /*#__PURE__*/React.createElement("span", null, tsa.totalGarages), /*#__PURE__*/React.createElement(Building2, {
    size: 18,
    color: "#0071e3"
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, tenants.length), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '12px',
      color: '#30d158',
      fontWeight: 600
    }
  }, "France & Switzerland Active")), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      padding: '20px'
    }
  ...
  }, /*#__PURE__*/React.createElement("span", null, tsa.totalRevenue), /*#__PURE__*/React.createElement(DollarSign, {
    size: 18,
    color: "#30d158"
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\u20AC", totalMRR.toLocaleString(), "/mo"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '12px',
      color: '#6e6e73'
    }
  }, "Recurring SaaS Subscription Volume")), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      padding: '20px'
    }
  ...
  }, /*#__PURE__*/React.createElement("span", null, "System Infrastructure"), /*#__PURE__*/React.createElement(Server, {
    size: 18,
    color: "#bf5af2"
  })), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    size: 20
  }), /*#__PURE__*/React.createElement("span", null, "100% Operational")), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '12px',
      color: '#6e6e73'
    }
  }, "EU Datacenter \u2022 LocalStorage Engine"))), /*#__PURE__*/React.createElement("div", {
    className: "apple-card",
    style: {
      overflow: 'hidden'
    }
  ...
  }, tsa.garagesList), /*#__PURE__*/React.createElement("div", {
    style: {
      overflowX: 'auto'
    }
  }, /*#__PURE__*/React.createElement("table", {
  ...
  }, "Garage / Facility"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px'
    }
  }, "Country / Currency"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px'
    }
  }, "Subscription Plan"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px'
    }
  }, "Tax Identifier"), /*#__PURE__*/React.createElement("th", {
    style: {
      padding: '14px 20px',
      textAlign: 'right'
    }
  }, "Actions"))), /*#__PURE__*/React.createElement("tbody", null, tenants.map(tenant => /*#__PURE__*/React.createElement("tr", {
    key: tenant.id,
    style: {
      borderBottom: '1px solid #f0f0f3'
    }
  ...
  }, tenant.address.city, ", ", tenant.address.countryCode, " \u2022 ", tenant.email)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '16px 20px'
    }
  }, /*#__PURE__*/React.createElement("span", {
    className: `apple-badge ${tenant.country === 'FR' ? 'apple-badge-blue' : 'apple-badge-amber'}`
  }, tenant.country, " (", tenant.currency, ")")), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '16px 20px'
    }
  }, /*#__PURE__*/React.createElement("span", {
    className: `apple-badge ${tenant.subscriptionTier === 'ai' ? 'apple-badge-blue' : 'apple-badge-neutral'}`,
    style: {
      textTransform: 'uppercase',
      fontWeight: 700
    }
  }, tenant.subscriptionTier)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '16px 20px'
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, tenant.taxIdentity.siret || tenant.taxIdentity.uid)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: '16px 20px',
      textAlign: 'right'
    }
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Switch to Garage"))))))))), isOnboardModalOpen && /*#__PURE__*/React.createElement("div", {
    className: "apple-modal-overlay",
  ...
  }, tsa.onboardGarage), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: '13px',
      color: '#6e6e73',
      marginBottom: '20px'
    }
  }, "Provision an isolated tenant environment for a new workshop."), /*#__PURE__*/React.createElement("form", {
  ...
  }, "Garage / Workshop Name"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: name,
  ...
  }, "Country & Jurisdictional Tax"), /*#__PURE__*/React.createElement("select", {
    value: country,
    ...
    value: "FR"
  }, "France (EUR / 20% TVA)"), /*#__PURE__*/React.createElement("option", {
    value: "CH"
  }, "Switzerland (CHF / 8.1% TVA)"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      fontSize: '12px',
      fontWeight: 600,
  ...
  }, "Subscription Plan"), /*#__PURE__*/React.createElement("select", {
    value: tier,
    ...
    value: "starter"
  }, "Starter (\u20AC89 / CHF 99)"), /*#__PURE__*/React.createElement("option", {
    value: "pro"
  }, "Pro Workshop (\u20AC189 / CHF 199)"), /*#__PURE__*/React.createElement("option", {
    value: "ai"
  }, "AI Enterprise (\u20AC299 / CHF 329)")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      gap: '10px'
  ...
  }, country === 'FR' ? 'SIRET (14 digits)' : 'Swiss UID (CHE-xxx)'), /*#__PURE__*/React.createElement("input", {
    type: "text",
    value: siret,
...
// --- FILE: components/AIAssistantDrawer.tsx ---
// ==========================================================================
...
const AIAssistantDrawer = ({
  ...
  const handleBookSlotFromAI = (slot, serviceId) => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, tai.title), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: '11px',
      color: '#86868b'
    }
  }, "Strict Function Calling Architecture \u2022 Zero DB Direct Writes"))), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    style: {
      background: 'none',
      border: 'none',
  ...
  }, conversation.map((msg, idx) => /*#__PURE__*/React.createElement("div", {
    key: idx,
    style: {
      display: 'flex',
      flexDirection: 'column',
  ...
  })), msg.aiData && msg.aiData.functionCalls.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '8px',
      maxWidth: '90%',
      background: '#1d1d1f',
    ...
    size: 12
  }), /*#__PURE__*/React.createElement("span", null, tai.simulatedFunctions)), msg.aiData.functionCalls.map((fc, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
    style: {
      marginBottom: '4px',
  ...
  }, fc.functionName), "(", /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#e5e5ea'
    }
  }, JSON.stringify(fc.arguments)), ") \u2794 ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: '#30d158'
    }
  }, JSON.stringify(fc.result))))), msg.aiData && msg.aiData.suggestedSlots.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: '10px',
      width: '100%',
      background: '#ffffff',
  ...
  }, tai.availableSlotsFound), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      gap: '8px'
    }
  }, msg.aiData.suggestedSlots.map((slot, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    type: "button",
  ...
  }), slot.date, " \u2022 ", slot.startTime, "-", slot.endTime, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: '10px',
      color: '#6e6e73',
      marginTop: '2px'
    }
  }, "Mech: ", slot.mechanicName, " (", slot.bayName, ")"))))))), loading && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '12px 16px',
      background: '#f5f5f7',
      borderRadius: '16px',
  ...
  }, "Analyzing symptoms..."), bookedSlot && /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#30d158',
      color: '#ffffff',
      padding: '12px',
    ...
    size: 16
  }), /*#__PURE__*/React.createElement("span", null, "Appointment successfully booked for ", bookedSlot, "!"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: '6px',
      overflowX: 'auto',
  ...
  }, ['Brake pedal squeaks & vibrates', 'Due for 60,000 km oil service', 'Tesla Model Y battery check', 'Check engine light code P0420'].map((prompt, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
    type: "button",
  ...
  }, prompt))), /*#__PURE__*/React.createElement("form", {
...
const App = () => {
  ...
  }), /*#__PURE__*/React.createElement("main", null, currentView === 'landing' && /*#__PURE__*/React.createElement(LandingPage, {
    onLaunchApp: () => setCurrentView('calendar'),
    onLaunchBooking: () => setCurrentView('booking-portal'),
    onOpenAi: () => setIsAiOpen(true),
    onOpenLegal: type => setLegalModalType(type),
    currentLanguage: currentLanguage
  }), currentView === 'calendar' && /*#__PURE__*/React.createElement(StaffCalendar, {
    activeTenant: activeTenant,
    currentLanguage: currentLanguage,
  ...
  }), currentView === 'work-orders' && /*#__PURE__*/React.createElement(WorkOrderBoard, {
    activeTenant: activeTenant,
    currentLanguage: currentLanguage,
  ...
  }), currentView === 'mechanic-bay' && /*#__PURE__*/React.createElement(MechanicTabletMode, {
    activeTenant: activeTenant,
    currentLanguage: currentLanguage,
    activeWorkOrderId: targetWorkOrderId,
    onWorkOrderFinished: () => setCurrentView('work-orders')
  }), currentView === 'customers' && /*#__PURE__*/React.createElement(CustomerDirectory, {
    activeTenant: activeTenant,
    currentLanguage: currentLanguage
  }), currentView === 'vehicles' && /*#__PURE__*/React.createElement(VehicleDirectory, {
    activeTenant: activeTenant,
    currentLanguage: currentLanguage
  }), currentView === 'quotes' && /*#__PURE__*/React.createElement(QuoteManager, {
    activeTenant: activeTenant,
    currentLanguage: currentLanguage,
    activeWorkOrderId: targetWorkOrderId,
  ...
  }), currentView === 'invoices' && /*#__PURE__*/React.createElement(InvoiceManager, {
    activeTenant: activeTenant,
    currentLanguage: currentLanguage,
    activeWorkOrderId: targetWorkOrderId
  }), currentView === 'booking-portal' && /*#__PURE__*/React.createElement(CustomerBookingPortal, {
    activeTenant: activeTenant,
    currentLanguage: currentLanguage,
    onBookingCompleted: () => {
      // Stay on confirmation or allow tracking
    }
  }), currentView === 'quote-approval-portal' && /*#__PURE__*/React.createElement(CustomerApprovalPortal, {
    magicToken: magicQuoteToken,
    currentLanguage: currentLanguage,
    onBackToApp: () => setCurrentView('quotes')
  }), currentView === 'tracking-portal' && /*#__PURE__*/React.createElement(CustomerTrackingPortal, {
    activeTenant: activeTenant,
    currentLanguage: currentLanguage
  }), currentView === 'comms-hub' && /*#__PURE__*/React.createElement(CommunicationsHub, {
    activeTenant: activeTenant,
    currentLanguage: currentLanguage
  }), currentView === 'super-admin' && /*#__PURE__*/React.createElement(SuperAdminDashboard, {
    currentLanguage: currentLanguage,
    onSwitchTenant: tenant => {
      handleSelectTenant(tenant);
      setCurrentView('calendar');
    }
  })), /*#__PURE__*/React.createElement(AIAssistantDrawer, {
    isOpen: isAiOpen,
  ...
  }), /*#__PURE__*/React.createElement(LegalModal, {
    type: legalModalType,
